...
![Pointer-based layout](/assets/img/packed/unpacked-tree.png){: w="300" }
...
<details>
  <summary>What it would look like without `PackedReader`</summary>

  Here is what a traversal on a packed `Tree` (defined in the next subsection) would look like without the `PackedReader` abstraction.
...
<details>
  <summary>The complete benchmark results table </summary>
  <p>
  <a href="/assets/img/packed/benchmark-table.png" class="popupimg-link">
    <img src="/assets/img/packed/benchmark-table.png" alt="Benchmark results" width="300" loading="lazy"/>
  </a>
  </p>
